...
<img src="https://ru-static.z-dn.net/files/d3e/19a39edd5f8f1e597c245010a71dbfc1.png" height="300">
...
- <code>избыточность</code> (вырожденность) : Одна аминокислота может иметь несколько кодовых триплетов (серин, аланин...). Только **триптофан** (tryptophan) и **метионин** (methionine) имеют **по одному кодон**
