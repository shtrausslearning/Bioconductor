...
Этап 1 : **<code>инициация</code>**
  - Начинается со связывания **РНК-полимеразы с промотором** и началом разъединения цепей ДНК
  ...
  - На этом этапе синтезируемая мРНК непрочно связана с транскрипционным комплексом (одна цепь ДНК, РНК-полимераза) и легко выходит из него
  - В этом случае инициация начинается вновь. Затем РНК-полимераза конформируется, связь мРНК с транскрипционным комплексом стабилизируется
