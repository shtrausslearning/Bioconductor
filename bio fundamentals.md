...
- универсальность : у всех организмов наследственная информация **зашифрована одинаковым способом**
- триплетность : единицей генетического кода является триплет нуклеотидов — кодон (Codon), который несет элементарную информацию — об одной аминокислоте;
- избыточность (вырожденность) : одна аминокислота может иметь несколько кодовых триплетов (серин, аланин...). Только **триптофан** и **метионин** имеют по одно- му кодон
