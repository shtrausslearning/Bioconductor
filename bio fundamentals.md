...
- <code>избыточность</code> (вырожденность) : Одна аминокислота может иметь несколько кодовых триплетов (серин, аланин...). Только **триптофан** и **метионин** имеют по одному кодон
...
Участок молекулы ДНК, структурно-функциональный эквивалент гена, на котором происходят транскрипционные процессы, называется <code>цистрон</code>
  - он состоит из последовательностей (sequences),
  - соответствующих структурному гену, и регуляторных последовательностей: промотора и терминатора (трейлера).
